...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        next: $('<a>' + options.labelNext + '</a>').attr("href", "#").addClass("btn btn-success buttonNext").attr("onclick", "nextEvent()"),
        previous: $('<a>' + options.labelPrevious + '</a>').attr("href", "#").addClass("btn btn-primary buttonPrevious").attr("onclick", "prevEvent()"),
        finish: $('<a>' + options.labelFinish + '</a>').attr("href", "#").addClass("btn btn-default buttonFinish").attr("onclick", "finishEvent()")
    };
